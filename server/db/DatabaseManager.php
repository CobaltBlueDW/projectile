...
class DatabaseManager {
    ...
    public static function connectAs($args) {
        ...
        if (self::$preConns[$args->username]) return self::$preConns[$args->username];
        ...
        self::$preConns[$args->username] = @new DatabaseManager($connection, $args->username);

        return self::$preConns[$args->username];
    }
     ...
     * @param array|mixed A list of values to be inserted into the
